...
--                                                                            --
-- The script employs linearized version of membrane transporters and         --
-- buffering. This is achieved by evaluating their fluxes at the previous     --
...
discBuffer:set_linearized_assembling()
...
if withRyR then
	ryr = RyRLinearized({"ca_cyt", "ca_er", "o2", "c1", "c2"}, erMemVec)
...
if withSERCAandLeak then
	...
	serca:set_linearized_assembling()
